...
def get_unique_rows(partial_rankings) -> np.ndarray:
    """
    Args:
        partial_rankings: NumbaLists of NumbaList
    """
    # Convert ragged object array to fixed-length padded array for uniqueness
    max_len = 0
